...
-----------------------------------------------------------------------------
-- Testbench for ESP on Xilinx ZCU106 (NB: the host ARM core is not simulated)
------------------------------------------------------------------------------
...
architecture behav of testbench is
  ...
  -- ESP top DDR AXI pins
  signal ddr_awid    : std_logic_vector(5 downto 0);
  ...
  signal ddr_wdata   : std_logic_vector(AXIDW - 1 downto 0);
  signal ddr_wstrb   : std_logic_vector(AW - 1 downto 0);
  signal ddr_wlast   : std_logic;
  signal ddr_wvalid  : std_logic;
  signal ddr_wready  : std_logic;
  signal ddr_bid     : std_logic_vector(5 downto 0);
  signal ddr_bresp   : std_logic_vector(1 downto 0);
  signal ddr_bvalid  : std_logic;
  signal ddr_bready  : std_logic;
  signal ddr_arid    : std_logic_vector(5 downto 0);
  ...
  signal ddr_rid     : std_logic_vector(5 downto 0);
  signal ddr_rdata   : std_logic_vector(AXIDW - 1 downto 0);
...
begin
  ...
  ddr_axi_si.aw.id(5 downto 0)             <= ddr_awid;
  ddr_axi_si.aw.id(XID_WIDTH - 1 downto 6) <= (others => '0');
  ...
  ddr_axi_si.ar.id(5 downto 0)             <= ddr_arid;
  ddr_axi_si.ar.id(XID_WIDTH - 1 downto 6) <= (others => '0');
