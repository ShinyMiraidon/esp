...
// /dev/mem. This mirrors the DE10-Pro loader flow for ZCU102 PS control.
...
#define ZCU102_PS_DDR_BACKING_BASE UINT64_C(0x0000000020000000)
...
static const struct cpu_profile cpu_profiles[] = {
    {
        ...
        .dram_ps_base = ZCU102_PS_DDR_BACKING_BASE,
